...
class Spider {
    ...
    start(firstTask){
        if(this.config.schedule){
            const Schedule = schedule.scheduleJob(this.config.schedule, function(y){
                console.info('It was a scheduled task that started after' + JSON.stringify(this.config.schedule));

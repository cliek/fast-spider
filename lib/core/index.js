...
class Spider {
    constructor(cfg) {
        ...
        try {
            ...
            logs.error('There is no config file in the current project directory');
        }
        ...
        if(this.config.queuePath !== queuePath) this.config.queuePath = this[_pathJoin](this.config.queuePath);
    }

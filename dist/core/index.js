...
var Spider = (function () {
    function Spider(thread_num, taskPath, opt) {
        var _this = this;
        this._roll = null;
        ...
        this._pool = new pool_1.default(this._thread_num, (0, path_1.resolve)(__dirname, 'worker.js'), {
            taskPath: taskPath
        });
        this._pool.events.on('message', function (res) {
            var type = res.type, result = res.result, nextTaskName = res.nextTaskName;
            switch (type) {
                case 'queue':
                    _this._mq.addQueue({
